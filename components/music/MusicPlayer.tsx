      ...
      <div className="flex items-center justify-center h-full rounded-xl bg-yellow-100 rounded-b-xl w-full">
        <div className="bg-white shadow-lg rounded-lg w-[45rem]">
          <div className="flex">
            <div>
              <img
                className="w-full rounded hidden md:block shadow-lg"
                src="/music-img.jpg"
                alt="Album Pic"
              />
            </div>
            <div className="w-full p-8">
              <div className="flex justify-between">
                <div>
                  ...
                  <p className="text-sm text-grey mt-1">URBUR dance music</p>
                </div>
              ...
              <div className="flex justify-between items-center mt-8">
                ...
                <div className="text-black p-8 rounded-full bg-yellow-light shadow-lg">
                  <svg
                    className="w-8 h-8"
                    fill="currentColor"
                    xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="mx-8 py-4">
            ...
            <div className="mt-1">
              <div className="h-1 bg-grey-dark rounded-full">
                <div className="w-1/5 h-1 bg-yellow-light rounded-full relative">
                  <span className="w-4 h-4 bg-yellow absolute pin-r pin-b -mb-1 rounded-full shadow"></span>
                </div>
              </div>
            </div>
          </div>
